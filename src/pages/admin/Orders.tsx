        ...
        <div className="table">
          ...
          {loading ? (
            ...
            current.map((o) => {
              ...
              return (
                <div className="table-row" key={o.id} style={{ gridTemplateColumns: '1.5fr 2fr 1.5fr 1fr 1fr 1.2fr 1fr' }}>
                  <div className="td" style={{ fontWeight: 700, color: '#8a93a3' }}>{o.code}</div>
                  <div className="td">
